        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="container-box">
                    ...
                    <button class="btn btn-success w-100" id="checkout">PAY NOW</button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(product => {
                        results += `<li class="list-group-item d-flex justify-content-between align-items-center" data-id="${product.id}" data-name="${product.name}" data-sale_price="${product.sale_price}">
    ...
    function updateGrandTotal() {
        ...
        $('table tbody tr').each(function() {
            subTotal += parseFloat($(this).find('.price').text()) * parseInt($(this).find('.qty').val());
